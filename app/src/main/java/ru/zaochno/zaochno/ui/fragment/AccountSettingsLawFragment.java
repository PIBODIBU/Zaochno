...
import ru.zaochno.zaochno.databinding.FragmentAccountSettingsLawBinding;
import ru.zaochno.zaochno.ui.callback.OnUserUpdateListener;

import static android.app.Activity.RESULT_OK;

public class AccountSettingsLawFragment extends Fragment {
    private static final int REQ_CODE_PICK_IMAGE = 9002;
    private static final String TAG = "SettingsLawFragment";
    ...
    private User user;
    private FragmentAccountSettingsLawBinding binding;
    private OnUserUpdateListener onUserUpdateListener;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_account_settings_law, container, false);
